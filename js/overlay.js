...
var loc=0;
	if(document.getElementById('content')) {
		loc=document.getElementById('content'); 
	}
	...
	oudeHTML=document.getElementById('subscribe').innerHTML;formulier=' of ontvang de nieuwste berichten via e-mail.<form  action="https://feedburner.google.com/fb/a/mailverify" method="post" target="popupwindow" onsubmit="window.open(\'https://feedburner.google.com/fb/a/mailverify?uri=Stoerke\', \'popupwindow\', \'scrollbars=yes,width=550,height=520\');return true"><p>Voer hier uw e-mail adres in:</p><p><input type="text" style="width:140px" name="email"/></p><input type="hidden" value="Stoerke" name="uri"/><input type="hidden" name="loc" value="en_US"/><input type="submit" value="volg stoerke" /></form>';
document.getElementById('subscribe').innerHTML=oudeHTML+formulier;}
